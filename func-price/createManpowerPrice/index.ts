...
import CreateManpowerPriceService from './services/createManpowerPriceService'
...
const httpTrigger: AzureFunction = async function (context: Context, req: HttpRequest): Promise<void> {
    ...
    try {
        ...
        const createManpowerPrice = container.resolve(CreateManpowerPriceService);
        const manpowerPrice = await createManpowerPrice.execute(req.body, accessToken);
        context.res = {
